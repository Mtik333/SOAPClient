...
public interface HelloWorld {
    ...
    @RequestWrapper(localName = "pdfReservation", targetNamespace = "http://soapserv.mycompany.com/", className = "com.mycompany.soapserv.PdfReservation")
    @ResponseWrapper(localName = "pdfReservationResponse", targetNamespace = "http://soapserv.mycompany.com/", className = "com.mycompany.soapserv.PdfReservationResponse")
    @Action(input = "http://soapserv.mycompany.com/HelloWorld/pdfReservationRequest", output = "http://soapserv.mycompany.com/HelloWorld/pdfReservationResponse")
    public byte[] pdfReservation(
    ...
    /**
     * @return returns java.util.List<com.mycompany.soapserv.RsiSeatReserved>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    ...
    /**
     * @return returns java.util.List<com.mycompany.soapserv.RsiSeat>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    ...
    /**
     * @return returns java.util.List<com.mycompany.soapserv.RsiAuditorium>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    ...
    /**
     * @return returns java.util.List<com.mycompany.soapserv.RsiClient>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    ...
    /**
     * @return returns java.util.List<com.mycompany.soapserv.RsiReservation>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    ...
    /**
     * @return returns java.util.List<com.mycompany.soapserv.RsiMovie>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    ...
    /**
     * @return returns java.util.List<com.mycompany.soapserv.RsiScreening>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "removeReservation", targetNamespace = "http://soapserv.mycompany.com/", className = "com.mycompany.soapserv.RemoveReservation")
    @ResponseWrapper(localName = "removeReservationResponse", targetNamespace = "http://soapserv.mycompany.com/", className = "com.mycompany.soapserv.RemoveReservationResponse")
    @Action(input = "http://soapserv.mycompany.com/HelloWorld/removeReservationRequest", output = "http://soapserv.mycompany.com/HelloWorld/removeReservationResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "changeReservation", targetNamespace = "http://soapserv.mycompany.com/", className = "com.mycompany.soapserv.ChangeReservation")
    @ResponseWrapper(localName = "changeReservationResponse", targetNamespace = "http://soapserv.mycompany.com/", className = "com.mycompany.soapserv.ChangeReservationResponse")
    @Action(input = "http://soapserv.mycompany.com/HelloWorld/changeReservationRequest", output = "http://soapserv.mycompany.com/HelloWorld/changeReservationResponse")
